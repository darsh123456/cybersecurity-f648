[cybersecurity-f648] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [cybersecurity-f648] container is NOT running**.

.. tip::
   You must have your [cybersecurity-f648] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/darsh123456/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/darsh123456/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=38533  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='darsh123456'  \-\-env DOCKERUSERNAME='djmodessa1726'  \-\-env MQTTUSERNAME='djmodessa'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
[cybersecurity-f648] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/darsh123456/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecurity-f648
...
.. important::
   solution_preprocessing_ml_ai_mqtt_dag-cybersecurity-f648
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=58955, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=38191, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=39427, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=32897, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=35785, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=43781, HPDEHOST=127.0.1.1, HPDEPORT=36555, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44237

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8734-cybersecurity-f648,solution_preprocessing_ml_ai_mqtt_dag-cybersecurity-f648, python-preprocess-3587-cybersecurity-f648,solution_preprocessing_ml_ai_mqtt_dag-cybersecurity-f648, python-ml-5591-cybersecurity-f648,solution_preprocessing_ml_ai_mqtt_dag-cybersecurity-f648, python-predict-5665-cybersecurity-f648,solution_preprocessing_ml_ai_mqtt_dag-cybersecurity-f648, python-ai-6818-cybersecurity-f648,solution_preprocessing_ml_ai_mqtt_dag-cybersecurity-f648, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
